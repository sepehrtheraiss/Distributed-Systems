...
dockerBuildTag = "assignment4" #put the tag for your docker build here
...
#   However, if that is all you are doing, the following tests should fail
    ...
    def test_i_add_node_to_network(self):
        ...
        newNode = dc.spinUpDockerContainer(dockerBuildTag, hostIp, networkIpPrefix+"4", newPort, "192.168.0.4:8080") # Modified. The only way new node won't gossip with others until put(newNode) has called.
        ...
        time.sleep(2) # wait so gossip happens
    ...
    def test_j_remove_node_from_network(self):
        ...
        self.confirmDeleteNode(ipPort=ipPort, 
                               removedAddress=removedNode["networkIpPortAddress"], # Modified was testScriptAddress
                               expectedStatus=200, 
                               expectedResult="Success", 
